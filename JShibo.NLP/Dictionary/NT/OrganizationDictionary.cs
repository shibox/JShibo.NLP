using JShibo.NLP.Algoritm.Ahocorasick.trie;
...
public class OrganizationDictionary
    {
         ...
         * 转移矩阵词典
         */
        public static TransformMatrixDictionary<Corpus.Tag.NT> transformMatrixDictionary;
        /**
         * AC算法用到的Trie树
         */
         ...
         * 本词典专注的词的ID
         */
        static int WORD_ID = CoreDictionary.getWordID(Predefine.TAG_GROUP);
        /**
         * 本词典专注的词的属性
         */
        ...
        static OrganizationDictionary()
    {
            ...
            transformMatrixDictionary = new TransformMatrixDictionary<Corpus.Tag.NT>(typeof(Corpus.Tag.NT));
...
//        trie.addKeyword("KGD");
    ...
    {
        EnumItem<Corpus.Tag.NT> nrEnumItem = dictionary.get(name);
        if (nrEnumItem == null) return false;
        return nrEnumItem.containsLabel(Corpus.Tag.NT.Z);
    }
}
