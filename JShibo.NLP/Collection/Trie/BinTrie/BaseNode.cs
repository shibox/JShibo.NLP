...
namespace JShibo.NLP.Collection.Trie.BinTrie
{
    /**
 * 节点，统一Trie树根和其他节点的基类
 *
    ...
    public abstract class BaseNode<V> : IComparable<BaseNode<V>>
{
     ...
     * 状态数组，方便读取的时候用
     */
    static Status[] ARRAY_STATUS = Status.values();
    /**
     * 子节点
     */
     ...
     */
    protected abstract bool addChild(BaseNode<V> node);
    ...
    protected void walkToSave(DataOutputStream out)
    {
        ...
        if (public int CompareTo(BinTrie.BaseNode other)
        {
